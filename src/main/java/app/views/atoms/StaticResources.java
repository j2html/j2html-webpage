...
public class StaticResources {
    ...
    public static Tag css_main_inline() {
        return unsafeHtml("html{background:url(/img/pattern.png) fixed;color:#43485a;font-family:arial,sans-serif}h1,h2,h3,nav a{font-family:\"Lato\",sans-serif}html{overflow-y:scroll}html,body{margin:0}*{font-weight:300;box-sizing:border-box}p{line-height:24px;text-align:justify}a{color:#3a96da}li{line-height:20px;margin:10px 0}p,li{font-size:15px}header a img{position:absolute;margin-left:-60px;margin-top:10px;max-width:50px}h1.banner{box-shadow:0 2px 6px rgba(0,0,0,0.3);margin:-20px -30px 0 -90px;text-align:center;font-size:35px;color:#fff;text-shadow:1px 1px 1px rgba(0,0,0,0.5);padding:15px}h2{margin-bottom:-10px}body{max-width:876px;margin:20px auto;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,0.5)}main{padding:20px}footer{border-top:1px solid #ddd;text-align:center;padding:10px}nav a{text-decoration:none;text-align:center;color:#2d425a;display:inline-block;width:19%;width:calc(25% - 50px);padding:25px 10px 5px;border-bottom:20px solid #fff;margin:0 25px;font-size:25px}.error-code{color:#acaebb;margin-bottom:0}a.active:nth-child(1){border-color:#f45a52}a.active:nth-child(2){border-color:#10a8c6}a.active:nth-child(3){border-color:#e4599d}a.active:nth-child(4){border-color:#54C781}#index h1{background:#f45a52}#download h1{background:#10a8c6}#examples h1{background:#e4599d}#news h1{background:#54C781}#not-found h1{background:#333}@media screen and (max-width: 1920px){html{background-size:35%}}@media screen and (max-width: 1024px){#fork-me,header a img{display:none}h1.banner{box-shadow:0 2px 6px rgba(0,0,0,0.3);margin:-20px 0 0;border-radius:0;font-size:25px;padding:15px}nav a{padding:15px 10px 10px;border-bottom:15px solid #fff;width:calc(25% - 40px);margin:0 20px;font-size:20px}}@media screen and (max-width: 666px){nav a{padding:15px 0 10px;margin:0 10px;width:calc(25% - 25px);font-size:16px}nav a:first-of-type{margin-left:20px}nav a:last-of-type{margin-right:20px}}@media screen and (max-width: 480px){nav a{font-size:12px}h1.banner{font-size: 18px}body{margin: 0}code{font-size: 12px}}.lols{text-align:center;font-size:9px;margin:0;color:#777}");
    }
